...
class GameStates {
    ...
    static Team = new GameState('Team', {x: -2, y: 1, z: -1}, {x: 0, y: -70, z: 0});
    static Contact = new GameState('Contact', {x: -1.3, y: 2.7, z: 2}, {x: 0, y: -30, z: 0});
    static Product = new GameState('Products', {x: 0.7, y: -0.1, z: 2.3}, {x: 0, y: 20, z: 0});
