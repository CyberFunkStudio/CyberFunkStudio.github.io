class GameState {
    constructor(name, position, rotation, textfieldIds, rigRotation, buttonPositions) {
        this.name = name;
...
class GameStates {
    ...
    static Team = new GameState('Team', { x: -2, y: 1, z: 1.4 }, { x: 0, y: -9, z: 0 }, ['About-Maxx', 'About-Anna'], { x: 0, y: -60, z: 0 });
